...
│   ├── _data/          # Global JSON/data files (e.g., homePage.json)
...
│   │   ├── logo.jpg
│   │   └── MohonkLake.jpeg
│   ├── blog/           # Content files (blog posts in Markdown)//trying to figure out how to move to _data folder but currently struggling
...
└── pnpm-lock.yaml      # Lockfile for pnpm (used to ensure fast Cloudflare builds)
